...
import com.sarvan.android.app.materialseekbar.R;
...
//		Log.d("onDraw", String.valueOf(mPoints));
		...
		TextDrawable textDrawable = new TextDrawable(String.valueOf(mPoints), getContext());
		mIndicatorIcon = textDrawable;
